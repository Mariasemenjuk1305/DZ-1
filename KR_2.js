...
getSel('.save').onclick = function () {
    ...
    let liNew = document.getElementsByTagName('ol');
    for (let j = 0; j < liNew.length; j++) {
        liNew[j].style.listTypeStyle = getSel('.liNumType').value;
        console.log(getSel('.liNumType').value);
    }
    let liNewI = document.getElementsByTagName('ul');
    for (let j = 0; j < liNewI.length; j++) {
        liNewI[j].style.listTypeStyle = getSel('.liImgType').value;
        console.log(getSel('.liImgType').value);
    }
